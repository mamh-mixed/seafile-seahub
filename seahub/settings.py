...
EXCALIDRAW_SERVER_URL = SEADOC_SERVER_URL
...
METADATA_SERVER_URL = os.environ.get('INNER_METADATA_SERVER_URL', '') or INNER_METADATA_SERVER_URL
...
if os.environ.get('ENABLE_FACE_RECOGNITION'):
